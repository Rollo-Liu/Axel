package org.axgl.render {
	...
	public class AxBlendMode {
		...
		public static const MULTIPLY:AxBlendMode = new AxBlendMode(Context3DBlendFactor.DESTINATION_COLOR, Context3DBlendFactor.ONE_MINUS_SOURCE_ALPHA);
		public static const SCREEN:AxBlendMode = new AxBlendMode(Context3DBlendFactor.ONE, Context3DBlendFactor.ONE_MINUS_SOURCE_COLOR);
	}
}
